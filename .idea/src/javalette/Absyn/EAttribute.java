...
public class EAttribute  extends Expr {
  public final Expr expr_;
  public final String ident_;
  public int line_num, col_num, offset;
  public EAttribute(Expr p1, String p2) { expr_ = p1; ident_ = p2; }

  public <R,A> R accept(javalette.Absyn.Expr.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(java.lang.Object o) {
    if (this == o) return true;
    if (o instanceof javalette.Absyn.EAttribute) {
      javalette.Absyn.EAttribute x = (javalette.Absyn.EAttribute)o;
