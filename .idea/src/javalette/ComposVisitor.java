...
public class ComposVisitor<A> implements
  ...
  javalette.Absyn.Member.Visitor<javalette.Absyn.Member,A>,
  ...
  javalette.Absyn.TypeBase.Visitor<javalette.Absyn.TypeBase,A>,
  ...
  javalette.Absyn.Br.Visitor<javalette.Absyn.Br,A>,
  javalette.Absyn.Bre.Visitor<javalette.Absyn.Bre,A>
{
    /* Prog */
    ...
    public javalette.Absyn.TopDef visit(javalette.Absyn.StructDef p, A arg)
    {
      String ident_ = p.ident_;
      javalette.Absyn.ListMember listmember_ = new javalette.Absyn.ListMember();
      for (javalette.Absyn.Member x : p.listmember_)
      {
        listmember_.add(x.accept(this,arg));
      }
      return new javalette.Absyn.StructDef(ident_, listmember_);
    }
    public javalette.Absyn.TopDef visit(javalette.Absyn.PtrTypeDef p, A arg)
    {
      String ident_1 = p.ident_1;
      String ident_2 = p.ident_2;
      return new javalette.Absyn.PtrTypeDef(ident_1, ident_2);
    }
    ...
    /* Member */
    public javalette.Absyn.Member visit(javalette.Absyn.StructMember p, A arg)
    {
      javalette.Absyn.Type type_ = p.type_.accept(this, arg);
      String ident_ = p.ident_;
      return new javalette.Absyn.StructMember(type_, ident_);
    }
    ...
    public javalette.Absyn.Stmt visit(javalette.Absyn.ArrayAss p, A arg)
    {
      javalette.Absyn.Expr expr_1 = p.expr_1.accept(this, arg);
      javalette.Absyn.ListBre listbre_ = new javalette.Absyn.ListBre();
      for (javalette.Absyn.Bre x : p.listbre_)
      {
        listbre_.add(x.accept(this,arg));
      }
      javalette.Absyn.Expr expr_2 = p.expr_2.accept(this, arg);
      return new javalette.Absyn.ArrayAss(expr_1, listbre_, expr_2);
    }
    public javalette.Absyn.Stmt visit(javalette.Absyn.ForEach p, A arg)
    {
      javalette.Absyn.Type type_ = p.type_.accept(this, arg);
      String ident_ = p.ident_;
      javalette.Absyn.Expr expr_ = p.expr_.accept(this, arg);
      javalette.Absyn.Stmt stmt_ = p.stmt_.accept(this, arg);
      return new javalette.Absyn.ForEach(type_, ident_, expr_, stmt_);
    }
    public javalette.Absyn.Stmt visit(javalette.Absyn.StructAss p, A arg)
    {
      javalette.Absyn.Expr expr_1 = p.expr_1.accept(this, arg);
      String ident_ = p.ident_;
      javalette.Absyn.Expr expr_2 = p.expr_2.accept(this, arg);
      return new javalette.Absyn.StructAss(expr_1, ident_, expr_2);
    }
    ...
    /* TypeBase */
    public javalette.Absyn.TypeBase visit(javalette.Absyn.Int p, A arg)
    {
      return new javalette.Absyn.Int();
    }
    public javalette.Absyn.TypeBase visit(javalette.Absyn.Doub p, A arg)
    {
      return new javalette.Absyn.Doub();
    }
    public javalette.Absyn.TypeBase visit(javalette.Absyn.Bool p, A arg)
    {
      return new javalette.Absyn.Bool();
    }
    public javalette.Absyn.TypeBase visit(javalette.Absyn.Void p, A arg)
    {
      return new javalette.Absyn.Void();
    }
    public javalette.Absyn.TypeBase visit(javalette.Absyn.Ptr p, A arg)
    {
      String ident_ = p.ident_;
      return new javalette.Absyn.Ptr(ident_);
    }

    /* Type */
    public javalette.Absyn.Type visit(javalette.Absyn.Base p, A arg)
    {
      javalette.Absyn.TypeBase typebase_ = p.typebase_.accept(this, arg);
      return new javalette.Absyn.Base(typebase_);
    }
    public javalette.Absyn.Type visit(javalette.Absyn.Array p, A arg)
    {
      javalette.Absyn.TypeBase typebase_ = p.typebase_.accept(this, arg);
      javalette.Absyn.ListBr listbr_ = new javalette.Absyn.ListBr();
      for (javalette.Absyn.Br x : p.listbr_)
      {
        listbr_.add(x.accept(this,arg));
      }
      return new javalette.Absyn.Array(typebase_, listbr_);
    }
    ...
    public javalette.Absyn.Expr visit(javalette.Absyn.EReference p, A arg)
    {
      javalette.Absyn.Expr expr_ = p.expr_.accept(this, arg);
      String ident_ = p.ident_;
      return new javalette.Absyn.EReference(expr_, ident_);
    }
    public javalette.Absyn.Expr visit(javalette.Absyn.EAttribute p, A arg)
    {
      javalette.Absyn.Expr expr_ = p.expr_.accept(this, arg);
      String ident_ = p.ident_;
      return new javalette.Absyn.EAttribute(expr_, ident_);
    }
    public javalette.Absyn.Expr visit(javalette.Absyn.EArray p, A arg)
    {
      javalette.Absyn.Expr expr_ = p.expr_.accept(this, arg);
      javalette.Absyn.ListBre listbre_ = new javalette.Absyn.ListBre();
      for (javalette.Absyn.Bre x : p.listbre_)
      ...
      return new javalette.Absyn.EArray(expr_, listbre_);
    }
    public javalette.Absyn.Expr visit(javalette.Absyn.EArrayInit p, A arg)
    {
      javalette.Absyn.TypeBase typebase_ = p.typebase_.accept(this, arg);
      javalette.Absyn.ListBre listbre_ = new javalette.Absyn.ListBre();
      for (javalette.Absyn.Bre x : p.listbre_)
      ...
      return new javalette.Absyn.EArrayInit(typebase_, listbre_);
    }
    public javalette.Absyn.Expr visit(javalette.Absyn.ENullPointer p, A arg)
    {
      String ident_ = p.ident_;
      return new javalette.Absyn.ENullPointer(ident_);
    }
    public javalette.Absyn.Expr visit(javalette.Absyn.EStructInit p, A arg)
    {
      String ident_ = p.ident_;
      return new javalette.Absyn.EStructInit(ident_);
    }
    ...
    /* Br */
    public javalette.Absyn.Br visit(javalette.Absyn.BrR p, A arg)
    {
      return new javalette.Absyn.BrR();
    }

    /* Bre */
    public javalette.Absyn.Bre visit(javalette.Absyn.BreR p, A arg)
    {
      javalette.Absyn.Expr expr_ = p.expr_.accept(this, arg);
      return new javalette.Absyn.BreR(expr_);
    }
}
