...
public class PrettyPrinter
{
  ...
  public static String print(javalette.Absyn.Member foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.Member foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.ListMember foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.ListMember foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.TypeBase foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.TypeBase foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.Br foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.Br foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.ListBr foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.ListBr foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.Bre foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.Bre foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(javalette.Absyn.ListBre foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(javalette.Absyn.ListBre foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  private static void pp(javalette.Absyn.TopDef foo, int _i_)
  {
    ...
    else     if (foo instanceof javalette.Absyn.StructDef)
    {
       javalette.Absyn.StructDef _structdef = (javalette.Absyn.StructDef) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("struct");
       pp(_structdef.ident_, 0);
       render("{");
       pp(_structdef.listmember_, 0);
       render("}");
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.PtrTypeDef)
    {
       javalette.Absyn.PtrTypeDef _ptrtypedef = (javalette.Absyn.PtrTypeDef) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("typedef");
       render("struct");
       pp(_ptrtypedef.ident_1, 0);
       render("*");
       pp(_ptrtypedef.ident_2, 0);
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.Member foo, int _i_)
  {
    if (foo instanceof javalette.Absyn.StructMember)
    {
       javalette.Absyn.StructMember _structmember = (javalette.Absyn.StructMember) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_structmember.type_, 0);
       pp(_structmember.ident_, 0);
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.ListMember foo, int _i_)
  {
    ppListMember(foo.iterator(), _i_);
  }

  private static void ppListMember(java.util.Iterator<javalette.Absyn.Member> it, int _i_)
  {
    if (it.hasNext())
    { /* cons */
      javalette.Absyn.Member el = it.next();
      pp(el, _i_); ppListMember(it, _i_);
    }
  }
  ...
  private static void pp(javalette.Absyn.Stmt foo, int _i_)
  {
    ...
    else     if (foo instanceof javalette.Absyn.ArrayAss)
    {
       javalette.Absyn.ArrayAss _arrayass = (javalette.Absyn.ArrayAss) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_arrayass.expr_1, 8);
       pp(_arrayass.listbre_, 0);
       render("=");
       pp(_arrayass.expr_2, 0);
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.ForEach)
    {
       javalette.Absyn.ForEach _foreach = (javalette.Absyn.ForEach) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("for");
       render("(");
       pp(_foreach.type_, 0);
       pp(_foreach.ident_, 0);
       render(":");
       pp(_foreach.expr_, 0);
       render(")");
       pp(_foreach.stmt_, 0);
    ...
    else     if (foo instanceof javalette.Absyn.StructAss)
    {
       javalette.Absyn.StructAss _structass = (javalette.Absyn.StructAss) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_structass.expr_1, 7);
       render("->");
       pp(_structass.ident_, 0);
       render("=");
       pp(_structass.expr_2, 0);
       render(";");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.TypeBase foo, int _i_)
  {
    ...
    else     if (foo instanceof javalette.Absyn.Ptr)
    {
       javalette.Absyn.Ptr _ptr = (javalette.Absyn.Ptr) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_ptr.ident_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  {
    if (foo instanceof javalette.Absyn.Base)
    {
       javalette.Absyn.Base _base = (javalette.Absyn.Base) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_base.typebase_, 0);
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.Expr foo, int _i_)
  {
    ...
    else     if (foo instanceof javalette.Absyn.EReference)
    {
       javalette.Absyn.EReference _ereference = (javalette.Absyn.EReference) foo;
       if (_i_ > 8) render(_L_PAREN);
       pp(_ereference.expr_, 7);
       render("->");
       pp(_ereference.ident_, 0);
       if (_i_ > 8) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.EAttribute)
    {
       javalette.Absyn.EAttribute _eattribute = (javalette.Absyn.EAttribute) foo;
       if (_i_ > 8) render(_L_PAREN);
       pp(_eattribute.expr_, 6);
       render(".");
       pp(_eattribute.ident_, 0);
       if (_i_ > 8) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.EArray)
    {
       javalette.Absyn.EArray _earray = (javalette.Absyn.EArray) foo;
       if (_i_ > 7) render(_L_PAREN);
       pp(_earray.expr_, 8);
       pp(_earray.listbre_, 0);
       if (_i_ > 7) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.EArrayInit)
    {
       javalette.Absyn.EArrayInit _earrayinit = (javalette.Absyn.EArrayInit) foo;
       if (_i_ > 6) render(_L_PAREN);
       render("new");
       pp(_earrayinit.typebase_, 0);
       pp(_earrayinit.listbre_, 0);
       if (_i_ > 6) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.ENullPointer)
    {
       javalette.Absyn.ENullPointer _enullpointer = (javalette.Absyn.ENullPointer) foo;
       if (_i_ > 6) render(_L_PAREN);
       render("(");
       pp(_enullpointer.ident_, 0);
       render(")");
       render("null");
       if (_i_ > 6) render(_R_PAREN);
    }
    else     if (foo instanceof javalette.Absyn.EStructInit)
    {
       javalette.Absyn.EStructInit _estructinit = (javalette.Absyn.EStructInit) foo;
       if (_i_ > 6) render(_L_PAREN);
       render("new");
       pp(_estructinit.ident_, 0);
       if (_i_ > 6) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.Br foo, int _i_)
  {
    if (foo instanceof javalette.Absyn.BrR)
    {
       javalette.Absyn.BrR _brr = (javalette.Absyn.BrR) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("[]");
       if (_i_ > 0) render(_R_PAREN);
    }
  ...
  private static void pp(javalette.Absyn.ListBr foo, int _i_)
  {
    ppListBr(foo.iterator(), _i_);
  }

  private static void ppListBr(java.util.Iterator<javalette.Absyn.Br> it, int _i_)
  {
    if (it.hasNext())
    {
      javalette.Absyn.Br el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
      ...
      { /* cons */
        pp(el, _i_); ppListBr(it, _i_);
      }
    }
  }


  private static void pp(javalette.Absyn.Bre foo, int _i_)
  {
    if (foo instanceof javalette.Absyn.BreR)
    {
       javalette.Absyn.BreR _brer = (javalette.Absyn.BreR) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("[");
       pp(_brer.expr_, 0);
       render("]");
  ...
  private static void pp(javalette.Absyn.ListBre foo, int _i_)
  {
    ppListBre(foo.iterator(), _i_);
  }

  private static void ppListBre(java.util.Iterator<javalette.Absyn.Bre> it, int _i_)
  {
    if (it.hasNext())
    {
      javalette.Absyn.Bre el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
  ...
  private static void sh(javalette.Absyn.TopDef foo)
  {
    ...
    if (foo instanceof javalette.Absyn.StructDef)
    {
       javalette.Absyn.StructDef _structdef = (javalette.Absyn.StructDef) foo;
       render("(");
       render("StructDef");
       sh(_structdef.ident_);
       render("[");
       sh(_structdef.listmember_);
       render("]");
       render(")");
    }
    if (foo instanceof javalette.Absyn.PtrTypeDef)
    {
       javalette.Absyn.PtrTypeDef _ptrtypedef = (javalette.Absyn.PtrTypeDef) foo;
       render("(");
       render("PtrTypeDef");
       sh(_ptrtypedef.ident_1);
       sh(_ptrtypedef.ident_2);
       render(")");
    }
  }
  ...
  private static void sh(javalette.Absyn.Member foo)
  {
    if (foo instanceof javalette.Absyn.StructMember)
    {
       javalette.Absyn.StructMember _structmember = (javalette.Absyn.StructMember) foo;
       render("(");
       render("StructMember");
       sh(_structmember.type_);
       sh(_structmember.ident_);
       render(")");
    }
  }

  private static void sh(javalette.Absyn.ListMember foo)
  {
     for (java.util.Iterator<javalette.Absyn.Member> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
       if (it.hasNext())
         render(",");
  ...
  private static void sh(javalette.Absyn.Stmt foo)
  {
    ...
    if (foo instanceof javalette.Absyn.ArrayAss)
    {
       javalette.Absyn.ArrayAss _arrayass = (javalette.Absyn.ArrayAss) foo;
       render("(");
       render("ArrayAss");
       sh(_arrayass.expr_1);
       render("[");
       sh(_arrayass.listbre_);
       render("]");
       sh(_arrayass.expr_2);
       render(")");
    }
    if (foo instanceof javalette.Absyn.ForEach)
    {
       javalette.Absyn.ForEach _foreach = (javalette.Absyn.ForEach) foo;
       render("(");
       render("ForEach");
    ...
    if (foo instanceof javalette.Absyn.StructAss)
    {
       javalette.Absyn.StructAss _structass = (javalette.Absyn.StructAss) foo;
       render("(");
       render("StructAss");
       sh(_structass.expr_1);
       sh(_structass.ident_);
       sh(_structass.expr_2);
       render(")");
    }
  }
  ...
  private static void sh(javalette.Absyn.TypeBase foo)
  {
    if (foo instanceof javalette.Absyn.Int)
    {
       javalette.Absyn.Int _int = (javalette.Absyn.Int) foo;
    ...
    if (foo instanceof javalette.Absyn.Ptr)
    {
       javalette.Absyn.Ptr _ptr = (javalette.Absyn.Ptr) foo;
       render("(");
       render("Ptr");
  ...
  private static void sh(javalette.Absyn.Expr foo)
  {
    ...
    if (foo instanceof javalette.Absyn.EReference)
    {
       javalette.Absyn.EReference _ereference = (javalette.Absyn.EReference) foo;
       render("(");
       render("EReference");
       sh(_ereference.expr_);
       sh(_ereference.ident_);
       render(")");
    }
    if (foo instanceof javalette.Absyn.EAttribute)
    {
       javalette.Absyn.EAttribute _eattribute = (javalette.Absyn.EAttribute) foo;
       render("(");
       render("EAttribute");
       sh(_eattribute.expr_);
       sh(_eattribute.ident_);
       render(")");
    }
    if (foo instanceof javalette.Absyn.EArray)
    {
       javalette.Absyn.EArray _earray = (javalette.Absyn.EArray) foo;
       render("(");
       render("EArray");
    ...
    if (foo instanceof javalette.Absyn.EArrayInit)
    {
       javalette.Absyn.EArrayInit _earrayinit = (javalette.Absyn.EArrayInit) foo;
       render("(");
       render("EArrayInit");
       sh(_earrayinit.typebase_);
       render("[");
       sh(_earrayinit.listbre_);
       render("]");
       render(")");
    }
    if (foo instanceof javalette.Absyn.ENullPointer)
    {
       javalette.Absyn.ENullPointer _enullpointer = (javalette.Absyn.ENullPointer) foo;
       render("(");
       render("ENullPointer");
       sh(_enullpointer.ident_);
       render(")");
    }
    if (foo instanceof javalette.Absyn.EStructInit)
    {
       javalette.Absyn.EStructInit _estructinit = (javalette.Absyn.EStructInit) foo;
       render("(");
       render("EStructInit");
       sh(_estructinit.ident_);
       render(")");
    }
  ...
  private static void sh(javalette.Absyn.Br foo)
  {
    if (foo instanceof javalette.Absyn.BrR)
    {
       javalette.Absyn.BrR _brr = (javalette.Absyn.BrR) foo;
  ...
  private static void sh(javalette.Absyn.ListBr foo)
  {
     for (java.util.Iterator<javalette.Absyn.Br> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
       if (it.hasNext())
         render(",");
  ...
  private static void sh(javalette.Absyn.Bre foo)
  {
    if (foo instanceof javalette.Absyn.BreR)
    {
       javalette.Absyn.BreR _brer = (javalette.Absyn.BreR) foo;
  ...
  private static void sh(javalette.Absyn.ListBre foo)
  {
     for (java.util.Iterator<javalette.Absyn.Bre> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
       if (it.hasNext())
         render(",");
