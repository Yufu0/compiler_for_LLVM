...
public class AbstractVisitor<R,A> implements AllVisitor<R,A> {
    ...
    public R visit(javalette.Absyn.StructDef p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.PtrTypeDef p, A arg) { return visitDefault(p, arg); }
    ...
    /* Member */
    public R visit(javalette.Absyn.StructMember p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(javalette.Absyn.Member p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* Blk */
    ...
    public R visit(javalette.Absyn.ArrayAss p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.ForEach p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.StructAss p, A arg) { return visitDefault(p, arg); }
    ...
    public R visit(javalette.Absyn.Ptr p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(javalette.Absyn.TypeBase p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* Type */
    public R visit(javalette.Absyn.Base p, A arg) { return visitDefault(p, arg); }
    ...
    public R visit(javalette.Absyn.EReference p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.EAttribute p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.EArray p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.EArrayInit p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.ENullPointer p, A arg) { return visitDefault(p, arg); }
    public R visit(javalette.Absyn.EStructInit p, A arg) { return visitDefault(p, arg); }
    ...
    /* Br */
    public R visit(javalette.Absyn.BrR p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(javalette.Absyn.Br p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
    /* Bre */
    public R visit(javalette.Absyn.BreR p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(javalette.Absyn.Bre p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
